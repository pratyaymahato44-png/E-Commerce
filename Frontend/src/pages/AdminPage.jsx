...
import { AdminProductsTableSkeleton } from "../components/LoadingSkeleton"
...
function AdminPage() {
	const { getToken, userData, modelOpen, setModelOpen, editing, setEditing, products, isLoading, saveMutation, deleteMutation } = useAdminProductPage()
	...
	return (
		<div className="text-left">
			...
			<dialog className={`modal ${modelOpen ? "modal-open" : ""}`}>
