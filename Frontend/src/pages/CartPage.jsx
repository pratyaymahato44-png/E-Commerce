...
function CartPage() {
	...
	const { checkout, checkoutLoading, items, lines, productsError, productsLoading, removeItem, setQuantity, subTotal } = useCartPage()
						...
						>
							...
							<div className="card-body min-w-0 flex-row flex-wrap items-center justify-between gap-4">
								...
								<div className="text-right font-semibold text-base-content">
									{p ? formatPrice(p.priceCents * item.quantity, p.currency) : "-"}
								</div>
							</div>
						</li>
					))}
