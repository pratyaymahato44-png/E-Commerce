...
import { OrderVideoSkeleton } from "../components/LoadingSkeleton"
...
function OrderVideoCallPage() {
    ...
    if (error || !order) {
        return <PageError message="Order not found or you don't have access."
    ...
    if (!paid) {
        return (
            <div role="alert" className="alert alert-info">
                <span>This order must be paid to join video support</span>
            </div>
        )
    }
...
export default OrderVideoCallPage