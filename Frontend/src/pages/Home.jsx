...
function Home() {
    ...
    const { products, categories, categoryChipsLoading, categoryFilter, error, loadingCategories, loadingList, setCategory } = useHomeCatalog()
    return (
        <div className="space-y-12">

            <HeroSection categories={categories} loadingCategories={loadingCategories} />
